...
int main() {
    ...
    // Introduction story
    printCentered("In a world shrouded in mystery and magic...");
    printCentered("You awaken next to a fairy, startled and defensive,");
    printCentered("swinging your stick to protect yourself.");
    printCentered("The fairy is hurt but reveals the stick is a powerful wand,");
    printCentered("elves on the door of deaths can set traps!");
    printCentered("capable of awakening only in the hands of the chosen warrior.");
    printCentered("She implores your help to save Eldoria from Amren,");
    printCentered("who seeks to claim the fruit of Eros and rule the realm.");

    // Introduction
    cout << "Welcome to the Mythical World!\n";
